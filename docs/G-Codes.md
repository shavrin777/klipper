...
disable only the given steppers. `<config_name>` can be one or more configured steppers, delimited with comma, for example `STEPPER=stepper_x,stepper_y ENABLE=1`. This is a diagnostic and debugging
